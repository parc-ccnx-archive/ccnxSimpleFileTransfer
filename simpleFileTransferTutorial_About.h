...
#ifndef simpleFileTransferTutorial_About_h
#define simpleFileTransferTutorial_About_h
/**
 * Embedded string containing information for the what(1) command.
 *
 */
extern const char *simpleFileTransferTutorial_What;
...
#endif // simpleFileTransferTutorial_About_h
